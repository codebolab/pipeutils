...
htmlhelp_basename = 'pipeutilsdoc'
...
latex_documents = [
    (master_doc, 'pipeutils.tex', 'pipeutils Documentation',
     'code.bo', 'manual'),
]
...
man_pages = [
    (master_doc, 'pipeutils', 'pipeutils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pipeutils', 'pipeutils Documentation',
     author, 'pipeutils', 'One line description of project.',
     'Miscellaneous'),
]
